...
public class TUSL<E>
	 ...
	 */
	public TUSL(Comparator<? super E> comparator) {
	 ...
	 */
	public TUSL(Collection<? extends E> c) {
		m = new ConcurrentSkipListMap<E,Object>();
		addAll(c);
	}
	 ...
	 * For use by submaps
	 */
	TUSL(ConcurrentNavigableMap<E,Object> m) {
		this.m = m;
	}
	...
	public TUSL<E> clone() {
		try {
			@SuppressWarnings("unchecked") TUSL<E> clone =
					(TUSL<E>) super.clone();
	...
	public NavigableSet<E> headSet(E toElement, boolean inclusive) {
		return new TUSL<E>(m.headMap(toElement, inclusive));
	}
	...
	public NavigableSet<E> tailSet(E fromElement, boolean inclusive) {
		return new TUSL<E>(m.tailMap(fromElement, inclusive));
	}
	...
	public NavigableSet<E> descendingSet() {
		return new TUSL<E>(m.descendingMap());
	}
